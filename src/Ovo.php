...
class Ovo
{
    ...
    const user_agent = "okhttp/4.11.0";
    ...
    */
    ...
    @ AGW ENDPOINT POST("/v4/api/oauth/otp/onboardingType")
    */
    public function sendOtp($phone_number)
    {
        ...
        return self::request(self::AGW_API . '/v4/api/oauth/otp/onboardingType', $field, $this->headers());
    }
